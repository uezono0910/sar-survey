        ...
        <div class="mt-8">
          <div class="w-full flex flex-col py-3">
            ...
            @if($surveyDetail->type == "テキストボックス")
              <input class="ml-4" type="text" name="surveyDetail_{{ $surveyDetail->id }}" />
            @elseif($surveyDetail->type == "テキストエリア")
              <textarea class="min-h-32 ml-4" name="surveyDetail_{{ $surveyDetail->id }}"></textarea>
            @elseif($surveyDetail->type == "セレクトボックス")
              <select class="w-1/2 ml-4" name="surveyDetail_{{ $surveyDetail->id }}">
